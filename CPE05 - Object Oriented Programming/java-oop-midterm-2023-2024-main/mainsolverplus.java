...
class HistoryReader {
    HistoryReader() throws Exception {
        ...
        if (choice == 0) {
            File file = new File("java-oop-midterm-2023-2024-main/One Side One Angle.txt");
            ...
            File file = new File("java-oop-midterm-2023-2024-main/Two sides with or without Angles.txt");
            Scanner scanner = new Scanner(file);
            String history = "";
            while (scanner.hasNextLine()) {
                history += scanner.nextLine() + "\n";
